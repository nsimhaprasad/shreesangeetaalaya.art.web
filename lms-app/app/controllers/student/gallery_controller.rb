class Student::GalleryController < ApplicationController
  ...
  def index
    ...
    unless @gallery_setting.is_enabled
      redirect_to student_dashboard_path, alert: 'Gallery is not available at this time.'
      return
    end
    ...
    render inertia: 'Student/Gallery/Index', props: {
