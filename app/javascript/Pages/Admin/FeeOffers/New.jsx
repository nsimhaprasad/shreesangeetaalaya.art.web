...
export default function New({ offer_types, statuses, applicable_to_options, duration_options, fee_offer, errors }) {
  const { data, setData, post, processing } = useForm({
    ...
    valid_from: fee_offer.valid_from || new Date().toISOString().split('T')[0],
    valid_to: fee_offer.valid_to || new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    status: fee_offer.status || 'active'
  })

  const handleSubmit = (e) => {
    e.preventDefault()
    post('/admin/fee_offers')
  }
  ...
  return (
    <Layout>
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Create Fee Offer</h1>
          <p className="mt-1 text-sm text-gray-600">
            Add a new discount or special package offer
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="text-sm font-medium text-blue-900 mb-2">Offer Guidelines:</h4>
                <ul className="text-sm text-blue-800 list-disc list-inside space-y-1">
                  <li>Percentage discounts must be between 0% and 100%</li>
                  <li>Set status to 'draft' to create the offer without activating it immediately</li>
                  <li>Offers can be applied to specific student categories</li>
                  <li>The system will automatically expire offers after the 'Valid To' date</li>
                </ul>
              </div>
              ...
              <div className="flex items-center justify-end space-x-3 pt-6 border-t">
                ...
                <Button
                  ...
                  disabled={processing}
                >
                  {processing ? 'Creating...' : 'Create Fee Offer'}
                </Button>
              </div>
            </div>
          </form>
