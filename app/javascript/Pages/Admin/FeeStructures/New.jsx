...
export default function New({ batches, class_types, fee_types, fee_structure, errors }) {
  const { data, setData, post, processing } = useForm({
    ...
    effective_from: fee_structure.effective_from || new Date().toISOString().split('T')[0],
    effective_to: fee_structure.effective_to || ''
  })

  const handleSubmit = (e) => {
    e.preventDefault()
    post('/admin/fee_structures')
  }
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Add a new fee structure for a batch
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 list-disc list-inside space-y-1">
                  ...
                  <li>If you don't specify an end date, this fee structure will remain active indefinitely</li>
                  <li>Make sure to set future fee structures with appropriate effective dates</li>
                </ul>
              </div>
